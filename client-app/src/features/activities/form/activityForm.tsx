...
import { Button, Form, HtmlInputrops, InputOnChangeData, Segment } from "semantic-ui-react";
...
export default function ActivityForm({closeForm, activity:selectedActivity,submitting, createOrEdit}:Props)
{
